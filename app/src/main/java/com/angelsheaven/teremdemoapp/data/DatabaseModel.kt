...
@Entity(tableName = "news", indices = [Index(value = ["type"])])
...
@Entity(tableName = "read_news", indices = [Index(value = ["readTime"])])
...
@Entity(tableName = "saved_news", indices = [Index(value = ["savedTime"])])
